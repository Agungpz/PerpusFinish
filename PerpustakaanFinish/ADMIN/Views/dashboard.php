                            ...
                            <tbody>
                                ...
                                foreach ($visits as $visit): ?>
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        <td class="py-2 px-4 text-left text-xs whitespace-nowrap"><?= $no++; ?></td>
                                        <td class="py-2 px-4 text-left text-xs">
                                            <?= htmlspecialchars($visit['nama_lengkap']); ?></td>
                                        <td class="py-2 px-4 text-left text-xs"><?= htmlspecialchars($visit['kelas']); ?>
                                        </td>
                                        <td class="py-2 px-4 text-left text-xs"><?= htmlspecialchars($visit['no_kartu']); ?>
                                        </td>
                                        <td class="py-2 px-4 text-left text-xs">
                                            <?= htmlspecialchars($visit['tanggal_kunjungan']); ?></td>
                                        <td class="py-2 px-4 text-left text-xs">
                                            <?= htmlspecialchars($visit['keperluan']); ?></td>
